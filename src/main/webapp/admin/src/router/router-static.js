...
import center from '@/views/center'
    ...
    import jiesanshetuan from '@/views/modules/jiesanshetuan/list'
    import jianlishetuan from '@/views/modules/jianlishetuan/list'
    import forum from '@/views/modules/forum/list'
    import shenqingcanjia from '@/views/modules/shenqingcanjia/list'
...
const routes = [{
	...
	path: '/jiesanshetuan',
        name: '解散社团',
        component: jiesanshetuan
      }
      ,{
	path: '/jianlishetuan',
        name: '建立社团',
        component: jianlishetuan
      }
      ,{
	path: '/forum',
        name: '话题交流',
