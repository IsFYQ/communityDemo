...
<div :style='{"width":"100%","padding":"40px 7%","margin":"0 auto","position":"relative","background":"none"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0","background":"none"}' label="社团目标" prop="shetuanmubiao">
            <el-input v-model="ruleForm.shetuanmubiao" 
                placeholder="社团目标" clearable ></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0","background":"none"}' label="社团简介" prop="shetuanjianjie">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="社团简介"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0","background":"none"}' label="社团详情" prop="shetuanxiangqing">
            <editor 
                ...
                v-model="ruleForm.shetuanxiangqing" 
                class="editor" 
                action="file/upload">
            </editor>
          </el-form-item>
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='shetuanmubiao'){
              this.ruleForm.shetuanmubiao = obj[o];
              this.ro.shetuanmubiao = true;
              continue;
            }
            if(o=='renshu'){
            ...
            if(o=='shetuanxiangqing'){
              this.ruleForm.shetuanxiangqing = obj[o];
              this.ro.shetuanxiangqing = true;
              continue;
            }
