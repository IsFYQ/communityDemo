<template>
  <div :style='{"padding":"30px 30px 0"}'>
    ...
    >  
     <el-row>
        <el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}'   v-if="flag=='xuesheng'"  label="学生账号" prop="xueshengzhanghao">
        ...
        <el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}'   v-if="flag=='xuesheng'"  label="年龄" prop="nianling">
          <el-input v-model="ruleForm.nianling"               placeholder="年龄" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}'   v-if="flag=='xuesheng'"  label="电话号码" prop="dianhuahaoma">
          <el-input v-model="ruleForm.dianhuahaoma"               placeholder="电话号码" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}'   v-if="flag=='xuesheng'"  label="社团类型" prop="shetuanleixing">
          <el-input v-model="ruleForm.shetuanleixing"               placeholder="社团类型" clearable></el-input>
        </el-form-item>
