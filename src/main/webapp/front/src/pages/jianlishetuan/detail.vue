...
<!--			显示轮播图 每个el-carousel-item表示一个轮播图元素-->
...
<!--      填写要新建的社团的信息-->
			<div class="info" :style='{"minHeight":"500px","width":"calc(70% - 320px)","padding":"20px 0","margin":"0 7% 0 3%","background":"none","flex":"1"}'>
				...
				<div class="item" :style='{"border":"0 dashed #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 1px","display":"flex","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#9f9fd7","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>社团人数</div>
					<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.shetuanrenshu}}</div>
				</div>
				<div class="item" :style='{"border":"0 dashed #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 1px","display":"flex","justifyContent":"spaceBetween"}'>
				...
				<div class="item" :style='{"border":"0 dashed #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 1px","display":"flex","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#9f9fd7","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>负责内容</div>
					<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.fuzeneirong}}</div>
				</div>
				<div class="item" :style='{"border":"0 dashed #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 1px","display":"flex","justifyContent":"spaceBetween"}'>
...
<!--        当点击审核时，就会调用onSH方法，将sfshVisiable设置为true，即显示弹窗-->
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"0","background":"#9f9fd7","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="isAuth('jianlishetuan','审核')" @click="onSH" type="warning">审核</el-button>
				</div>
			</div>
			
		</div>
		
<!--		选项卡组件，用于在一个页面显示多个选项卡 选项卡组件中一开始会渲染activeName中指定的内容（空），当用户点击不同的标签栏时，activeName会更新为新的标签名，然后渲染出新的页面-->
...
<!--    审核是此对话框的标题，当点击页面上的审核时，就会显示出此对话框-->
