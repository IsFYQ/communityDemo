<template>
	<div class="addEdit-block" :style='{"padding":"30px 30px 0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'" label="加入编号" prop="jiarubianhao">
					<el-input v-model="ruleForm.jiarubianhao" placeholder="加入编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.jiarubianhao" label="加入编号" prop="jiarubianhao">
					<el-input v-model="ruleForm.jiarubianhao" placeholder="加入编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="社团名称" prop="shetuanmingcheng">
					<el-input v-model="ruleForm.shetuanmingcheng" placeholder="社团名称" clearable  :readonly="ro.shetuanmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="社团名称" prop="shetuanmingcheng">
					<el-input v-model="ruleForm.shetuanmingcheng" placeholder="社团名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="社团标签" prop="shetuanbiaoqian">
					<el-input v-model="ruleForm.shetuanbiaoqian" placeholder="社团标签" clearable  :readonly="ro.shetuanbiaoqian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="社团标签" prop="shetuanbiaoqian">
					<el-input v-model="ruleForm.shetuanbiaoqian" placeholder="社团标签" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="人数" prop="renshu">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="人数" prop="renshu">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="加入学生账号" prop="jiaruxueshengzhanghao">
					<el-input v-model="ruleForm.jiaruxueshengzhanghao" placeholder="加入学生账号" clearable  :readonly="ro.jiaruxueshengzhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="加入学生账号" prop="jiaruxueshengzhanghao">
					<el-input v-model="ruleForm.jiaruxueshengzhanghao" placeholder="加入学生账号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="加入学生姓名" prop="jiaruxueshengxingming">
					<el-input v-model="ruleForm.jiaruxueshengxingming" placeholder="加入学生姓名" clearable  :readonly="ro.jiaruxueshengxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="加入学生姓名" prop="jiaruxueshengxingming">
					<el-input v-model="ruleForm.jiaruxueshengxingming" placeholder="加入学生姓名" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="学生账号" prop="xueshengzhanghao">
					<el-input v-model="ruleForm.xueshengzhanghao" placeholder="学生账号" clearable  :readonly="ro.xueshengzhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="学生账号" prop="xueshengzhanghao">
