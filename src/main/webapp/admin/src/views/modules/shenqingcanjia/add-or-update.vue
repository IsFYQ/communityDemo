<template>
	<div class="addEdit-block" :style='{"padding":"30px 30px 0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'" label="申请编号" prop="shenqingbianhao">
					<el-input v-model="ruleForm.shenqingbianhao" placeholder="申请编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.shenqingbianhao" label="申请编号" prop="shenqingbianhao">
					<el-input v-model="ruleForm.shenqingbianhao" placeholder="申请编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="活动名称" prop="huodongmingcheng">
					<el-input v-model="ruleForm.huodongmingcheng" placeholder="活动名称" clearable  :readonly="ro.huodongmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="活动名称" prop="huodongmingcheng">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="申请学生账号" prop="shenqingxueshengzhanghao">
					<el-input v-model="ruleForm.shenqingxueshengzhanghao" placeholder="申请学生账号" clearable  :readonly="ro.shenqingxueshengzhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="申请学生账号" prop="shenqingxueshengzhanghao">
					<el-input v-model="ruleForm.shenqingxueshengzhanghao" placeholder="申请学生账号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="申请学生姓名" prop="shenqingxueshengxingming">
					<el-input v-model="ruleForm.shenqingxueshengxingming" placeholder="申请学生姓名" clearable  :readonly="ro.shenqingxueshengxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="申请学生姓名" prop="shenqingxueshengxingming">
					<el-input v-model="ruleForm.shenqingxueshengxingming" placeholder="申请学生姓名" readonly></el-input>
				</el-form-item>
	...
	data() {
		...
		return {
			...
			ro:{
				...
				shenqingxueshengzhanghao : false,
				shenqingxueshengxingming : false,
			...
			ruleForm: {
				...
				huodongmingcheng: '',
				shenqingshijian: '',
				shenqingxueshengzhanghao: '',
				shenqingxueshengxingming: '',
				xueshengzhanghao: '',
				xueshengxingming: '',
				shhf: '',
			},
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='shenqingxueshengzhanghao'){
							this.ruleForm.shenqingxueshengzhanghao = obj[o];
							this.ro.shenqingxueshengzhanghao = true;
							continue;
						}
						if(o=='shenqingxueshengxingming'){
							this.ruleForm.shenqingxueshengxingming = obj[o];
							this.ro.shenqingxueshengxingming = true;
							continue;
						}
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(((json.xueshengzhanghao!=''&&json.xueshengzhanghao) || json.xueshengzhanghao==0) && this.$storage.get("role")!="管理员"){
						this.ruleForm.shenqingxueshengzhanghao = json.xueshengzhanghao
						this.ro.shenqingxueshengzhanghao = true;
					}
					if(((json.xueshengxingming!=''&&json.xueshengxingming) || json.xueshengxingming==0) && this.$storage.get("role")!="管理员"){
						this.ruleForm.shenqingxueshengxingming = json.xueshengxingming
						this.ro.shenqingxueshengxingming = true;
					}
				} else {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shenqingcanjia/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shenqingcanjiaCrossAddOrUpdateFlag = false;
						 this.parent.search();
